...
export const ErrorFeedback = () => {
  ...
  return (
    <main
      className="h-fit flex items-center py-20 justify-center bg-cover bg-center"
      style={{ backgroundImage: "url('/fondo-hojas.png')" }}
    >
      <section className="rounded-2xl shadow-lg bg-black/50 font-Poppins text-white text-center p-10 max-w-lg">
